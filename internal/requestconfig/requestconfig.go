...
import (
	...
	"github.com/yoshi-ai-dev/yoshi-go/internal/apierror"
	"github.com/yoshi-ai-dev/yoshi-go/internal/apiform"
	"github.com/yoshi-ai-dev/yoshi-go/internal/apiquery"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Yoshi/Go %s", internal.PackageVersion),
	}
}
