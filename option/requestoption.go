...
// RequestOption is an option for the requests made by the yoshi API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/yoshi-ai-dev/yoshi-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.yoshi.ai/v1/")
}
...
func WithEnvironmentStaging() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://staging-api.yoshi.ai/v1/")
}
